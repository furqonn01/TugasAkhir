                    ...
                    <table class="table table-bordered dataTable" id="dataTable" role="grid"
                        ...
                        <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                    ...
                                    aria-label="Name: activate to sort column descending">Kode Jabatan Struktural</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                    style="width: 248px;" aria-label="Position: activate to sort column ascending">Nama
                                    Jabatan</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                <td>{{$d->id_struktural}}</td>
                                <td>{{$d->nama_jabatan}}</td>
                                <td>
                                    <!-- Button trigger modal -->
                                    <!-- Button trigger modal -->
                                    <a href="/pegawai/tmjabatans/hapus/{{$d->id_struktural}}" class="btn btn-danger"><i
